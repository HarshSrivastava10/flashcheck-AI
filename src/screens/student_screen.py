...
def student_screen():
    ...
    st.space()
    st.space()
    pic_source = st.camera_input("Position your face in the center")

    if pic_source:
        img = np.array(Image.open(pic_source))

        with st.spinner('System is scanning...'):
    ...
    if show_registration:
        with st.container(border=True):
            ...
            new_name = st.text_input("Enter your name", placeholder='E.g. Harsh Srivastava')
            ...
            try:
                audio_data = st.audio_input('Record a short phase like I am present, My name is Harsh.')
            except Exception:
