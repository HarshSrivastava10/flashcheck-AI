...
def subject_card(name, code, section, stats=None, footer_callback=None):
    # Keep HTML strings flush to the left to avoid accidental markdown code blocks
    html = f"""
<div style="background:white;
    ...
    <p style="color:#64748b;margin:10px;">
        Code :
...
"""
    ...
    # CRITICAL FIX: Strip all leading/trailing whitespace and remove empty line triggers
